...
import '../Message/ScreenMessage.dart';
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => WebViewScreen(
                              url:
                                  'https://www.segucom.mx/mobile/grid_ALERTA_MOVIL/?xElemen=$_numElemento',
                              title: 'Alertamientos',
                            ),
                          ),
                        );
                      ...
                      () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => WebViewScreen(
                              url:
                                  'https://www.segucom.mx/mobile/grid_CONSIGNA_MOVIL/?xElemen=$_numElemento',
                              title: 'Consignas',
                            ),
                          ),
                        );
...
class WebViewScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Text('WebView goes here: $url')),
    );
  }
}
